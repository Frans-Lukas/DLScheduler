#!/bin/bash
export COMMAND='python TensorFlow/main.py'
...
DMLC_ROLE=TensorFlow DMLC_PS_ROOT_URI=127.0.0.1 DMLC_PS_ROOT_PORT=9092 DMLC_NUM_SERVER=1 DMLC_NUM_WORKER=1 $COMMAND
