...
DMLC_ROLE=worker DMLC_PS_ROOT_URI=127.0.0.1 DMLC_PS_ROOT_PORT=9092 JOB_ID=job_id DMLC_NUM_SERVER=1 DMLC_NUM_WORKER=1 GOOGLE_APPLICATION_CREDENTIALS=/home/franslukas/PycharmProjects/DLScheduler/MXNetImplementations/nuclio_executioner/secret_key.json $COMMAND
