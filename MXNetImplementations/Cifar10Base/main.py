...
#regexpresultstart{"loss":1.4936603, "accuracy":0.61814, "worker_id":0}regexpresultend
#regexpresultstart{"loss":0.5915609, "accuracy":0.7237, "worker_id":0}regexpresultend
#regexpresultstart{"loss":0.25407395, "accuracy":0.78106, "worker_id":0}regexpresultend
#regexpresultstart{"loss":0.46207494, "accuracy":0.82876, "worker_id":0}regexpresultend
...
def main():
    ...
    train_data = gluon.data.DataLoader(
        ...
        sampler=SplitSampler(25000, num_parts, store.rank))
    ...
    with open('results_cifar.json', 'w') as f:
