...
if [[ $# -eq 7 ]]; then
  ...
  echo '{"ip": "'$2'", "role": "'$3'", "num_worker": "'$4'", "num_server": "'$5'", "script_path": "'$6'", "job_id": "'$7'", "num_parts": "1"}'
  nuctl invoke $1 -n nuclio -b '{"ip": "'$2'", "role": "'$3'", "num_worker": "'$4'", "num_server": "'$5'", "script_path": "'$6'", "job_id": "'$7'", "num_parts": "1"}'
elif [[ $# -eq 8 ]]; then
